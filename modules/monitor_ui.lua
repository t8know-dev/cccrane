...
function M.createUI(monitor, stateModule)
    ...
    -- Up/down buttons: width=5, equal margins
    -- Total width = 5 + 1(gap) + 5 = 11. Margin each side = (15-11)/2 = 2
    local navBtnW = 5
    local navX = math.floor((w - navBtnW * 2 - 1) / 2)
